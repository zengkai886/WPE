...
- Test the public seams explicitly specified by sections 3, 4 and 9: primitive codec, stream framing, packet frames, bounded queue, and the five-message frontend bridge. Golden wire bytes/queue transitions come from the unchanged original C# source, never from the C++ implementation under test.
