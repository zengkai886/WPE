...
chosen=['SystemConfig','InjectMode','ProxyMode','ProxyAccount','ProxyAccountIPInfo','Filter','Send','SendCollection','Robot','RobotInstruction','WareHouse','WareHouseData','WhiteList','BlackList']
